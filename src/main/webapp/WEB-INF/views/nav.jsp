      ...
      <div class="flex-1 md:flex md:items-center md:justify-between hidden mobile-menu">
        <div class="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
          ...
          <div class="flex items-center mt-3 md:mt-0">
            <a href="/announcements" class="mx-4 text-green-600 md:block dark:text-green-200 hover:text-green-700 dark:hover:text-green-400 focus:text-green-700 dark:focus:text-green-400 focus:outline-none" aria-label="show notifications">
